...
//         I'd have to hear from you! If you have any questions, comments,or feedback,
//         please use the from blow.
//       </p>

//     <form className='max-w-2xl mx-auto' >
//         <div className='grid  lg: grid-cols-auto gap-6 mt-10 mb-8'>
//             <input type="text" placeholder='Enter your name' required
//             className='flex-1 p-3 outline-none border-[0.5px] border-gray-400 rounded-md bg-white'/>
//             <input type="email" placeholder='Enter your email' required
//             className='flex-1 p-3 outline-none border-[0.5px] border-gray-400 rounded-md bg-white'/>
//             <textarea rows='6' placeholder='Enter your massaged' required
...
// import { assets } from '@/assets/assets'; // ✅ Make sure assets file exists and exports the image path
