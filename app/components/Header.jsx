  ...
  return (
    <div className=" text-black w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
      ...
      <h1 className="text-3xl sm:text-6xl lg:text-[-66px] font-Ovo">
        frontend web developer based in Bangaldesh
      </h1>
      <p className="max-w-2xl mx-auto font-Ovo">
        I am a Frontedn developer from Bangaldesh ,Dhaka with 1 year of
        experience in multiple caomanies like brain starion{" "}
      </p>
